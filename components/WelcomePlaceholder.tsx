...
export const WelcomePlaceholder: React.FC<WelcomePlaceholderProps> = ({ onAddNewCard }) => {
    return (
        <div className="text-center p-12 md:p-24 bg-gradient-to-b from-white to-slate-50 rounded-2xl shadow-card border border-slate-200/80 mt-8">
            <div 
            ...
            <button
                ...
                className="inline-flex items-center gap-2 px-6 py-3 bg-slate-800 text-white font-semibold rounded-lg shadow-md hover:scale-[1.03] hover:shadow-lg hover:bg-slate-700 transition-all duration-300 transform focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-slate-800"
            >
