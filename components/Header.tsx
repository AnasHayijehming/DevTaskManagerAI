...
const Header: React.FC<HeaderProps> = ({ currentFilter, onFilterChange, onAddNewCard, onKnowledgeBaseClick, onSettingsClick }) => {
  ...
  return (
    <header className="bg-white/90 backdrop-blur-lg shadow sticky top-0 z-20 border-b border-slate-200/80">
      <div className="px-4 sm:px-6 md:px-8 py-3 flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2">
            ...
            <button
                ...
                className="flex items-center gap-2 px-4 py-2 bg-slate-800 text-white font-semibold rounded-lg shadow-sm hover:bg-slate-700 transition-all duration-200 transform hover:scale-[1.03]"
            >
